        ...
        <div class="main">
            ...
            <div class="container">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo '<thead><tr><th>User ID</th><th>Password</th><th>Role</th><th>Action</th></tr></thead>';
                    echo '<tbody>';
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td>';
                        echo '<a href="edit.php?userID=' . $row["userID"] . '" class="btn btn-primary">Edit</a> ';
                        echo '<a href="delete.php?userID=' . $row["userID"] . '" class="btn btn-danger">Delete</a>';
                        echo '</td>';
                        echo '</tr>';
                    }
                    echo '</tbody></table>';
